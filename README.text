...
First of all you will need to download Python from the main page (https://www.python.org/downloads/), then tick the checkbox "Add Python.exe to PATH" before you install it
