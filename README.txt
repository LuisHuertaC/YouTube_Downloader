...
Second, you need create a new folder anywhere you want (create it in Documents or Desktop will be fine), then save the main code (app.py), "setup.bat", "requirements.txt", "styles.css" (inside a folder called "static"), "index.html" (inside a folder called "templates") and "cookies.txt" in there 
